...
<footer class="relative mt-20 text-white site-footer bg-old-black">
	...
	<div class="grid grid-cols-1 p-4 site-info sm:grid-cols-2 md:grid-cols-4">
		<div class="col-span-4 m-2 lg:col-span-1">
			...
			<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/dist/images/university.shield.svg" class="w-full h-auto p-5 sm:w-1/2 sm:mx-auto lg:w-full max-w-87.5 mx-auto" alt="JHU shield in the footer">
			</a>
		</div>
		...
		<div class="col-span-4 my-2">
			<?php if ( get_field( 'custom_address', 'option' ) ) : ?>
				<div class="text-center">&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?>
