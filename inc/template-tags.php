...
if ( ! function_exists( 'ksas_blocks_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function ksas_blocks_posted_on() {
...
if ( ! function_exists( 'ksas_blocks_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'ksas_blocks_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function ksas_blocks_entry_footer() {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'ksas-blocks' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'ksas_blocks_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function ksas_blocks_post_thumbnail() {
...
function twentytwenty_add_sub_toggles_to_main_menu( $args, $item, $depth ) {
	...
	if ( isset( $args->show_toggles ) && $args->show_toggles ) {
		...
		if ( in_array( 'menu-item-has-children', $item->classes, true ) ) {
			...
			$args->after .= '<button class="toggle sub-menu-toggle fill-children-current-color" data-toggle-target="' . $toggle_target_string . '" data-toggle-type="slidetoggle" data-toggle-duration="' . absint( $toggle_duration ) . '" aria-expanded="false"><span class="screen-reader-text">' . __( 'Show sub menu', 'ksas-blocks' ) . '</span>' . twentytwenty_get_theme_svg( 'chevron-down' ) . '</button>';
